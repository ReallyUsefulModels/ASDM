...
class SmokingCessation(Structure):
    def __init__(self):
        ...
        self.add_flow(
            "smokersQuitting",
            "smokingCessationServiceFunding/spendPerQuitter",
            flow_from="currentSmokers",
            flow_to="exSmokers",
        )
        self.add_flow(
            "exSmokersStartingAgain",
            "exSmokers*averageQuitterFailureRate",
            flow_from="exSmokers",
            flow_to="lapsedExSmokers",
        )
        ...
        self.add_aux(
            "smokingCessationServiceFunding",
            "(healthcareSavings*percentageOfSavingsSpentOnCessation)/100",
        )
...
df_smoking = df_smoking_outcome[
    ["currentSmokers", "exSmokers", "exSmokersStartingAgain"]
]
